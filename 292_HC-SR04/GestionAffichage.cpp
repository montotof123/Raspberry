...
GestionAffichage::GestionAffichage() {
	afficheur4.init(GPIO26, GPIO05, GPIO06, GPIO13, GPIO19, GPIO12);
	afficheur3.init(GPIO26, GPIO05, GPIO06, GPIO13, GPIO19, GPIO16);
	afficheur2.init(GPIO26, GPIO05, GPIO06, GPIO13, GPIO19, GPIO20);
	afficheur1.init(GPIO26, GPIO05, GPIO06, GPIO13, GPIO19, GPIO21);
}
