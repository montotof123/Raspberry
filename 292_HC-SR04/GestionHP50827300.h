...
public:
	GestionHP50827300();
	GestionHP50827300(PinGPIO, PinGPIO, PinGPIO, PinGPIO, PinGPIO, PinGPIO);
...
private:
	GestionPinGPIO PinInput1;
	GestionPinGPIO PinInput2;
	GestionPinGPIO PinInput4;
	GestionPinGPIO PinInput8;
	GestionPinGPIO PinDecimalPoint;
	GestionPinGPIO PinLatchEnable;
