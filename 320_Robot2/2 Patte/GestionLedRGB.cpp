...
// @Param ledType
// **************
GestionLedRGB::GestionLedRGB(GestionLedRGB::LedType pLedType) {
	ledType = pLedType;
}
...
// @Param ledType
// **************
void GestionLedRGB::setType(GestionLedRGB::LedType pLedType) {
	ledType = pLedType;
}
...
// @return ledType
// ***************
GestionLedRGB::LedType GestionLedRGB::getType(void) {
	return ledType;
}
